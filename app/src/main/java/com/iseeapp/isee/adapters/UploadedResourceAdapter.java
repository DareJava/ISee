...
public class UploadedResourceAdapter extends RecyclerView.Adapter<UploadedResourceAdapter.MyViewHolder> {
    ...
    public UploadedResourceAdapter(List<UploadedResource> moviesList) {
